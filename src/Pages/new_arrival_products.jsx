                ...
                <div className='container'>
                    <div className='new_arrival_products'>
                        <div className='new_arrival_brand'>
                            <h1 className='xl_body_text new_arrival_text'>New Arrivals Products</h1>
                    ...
                    <div className='new_arrival_collection'>
...
export default New_arrival_products